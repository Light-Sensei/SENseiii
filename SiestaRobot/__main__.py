    ...
    try:
        if mod_match:
            ...
            if isinstance(help_list, list):
                ...
                help_text = help_list
            text = (
                "*♥ Click on the button bellow to get description about specifics command. ♥*\nIf You Face Any Problems Please Report It To Our [Support Group.](https://t.me//yorXsupport) ".format(
...
def siesta_about_callback(update, context):
    ...
    if query.data == "more_":
        ...
        query.message.edit_text(
            text="*♥  Yor Robot support chats ♥*\nJoin My Support Group/Channel for see or report a problem on Shikimori Support.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def main():
    ...
    help_callback_handler = CallbackQueryHandler(
        help_button, pattern=r"help_back.*", run_async=True
    )
