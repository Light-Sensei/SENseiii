...
def sex(update: Update, context: CallbackContent):
    reply_text = update.effective_message.reply_to_messag.reply_text if update.effective_message.reply_to_message else update.effective_message.reply_text
    reply_text(random.choice(fun_string.{}))
...
SEX_HANDLER = DisableAlbeCommandHandler("sex", sex, run_async=True)
